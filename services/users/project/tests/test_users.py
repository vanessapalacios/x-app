...
class TestUserService(BaseTestCase):
    ...
    def test_single_user(self):
        ...
        with self.client:
            ...
            self.assertIn('fiorellapalacios@upeu.edu.pe', data['data']['email'])
            self.assertIn('success', data['status'])
    ...
    def test_all_users(self):
        ...
        with self.client:
            ...
            self.assertIn('fiorellapalacios@upeu.edu.pe', data['data']['users'][0]['email'])
    ...
    def test_main_add_user(self):
        """
        Aseguramos que un nuevo usuario pueda ser agregado a la db mediante post request
        """
        with self.client:
            response = self.client.post(
                '/',
                data= dict(username='vanessa', email='fiorellapalacios@upeu.edu.pe'),
